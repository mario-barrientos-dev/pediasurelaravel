...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('last_name')); ?>" required autocomplete="last_name" placeholder="Apellido" autofocus maxlength="190">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <input id="identification" name="identification" type="number" class="form-control <?php $__errorArgs = ['identification'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('identification')); ?>" required autocomplete="identification" placeholder="Número de identificación" maxlength="30">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-12">
                                <input id="phone" name="phone" type="number" class="form-control <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('phone')); ?>" required autocomplete="phone" placeholder="Número de teléfono" maxlength="10">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <label>
                                    ...
                                    Acepto
                                    <a class="terminoslink" href="<?php echo e(route('regulation')); ?>" target="_blank">Términos y condiciones</a>
                                    y Política de Privacidad
                                </label>
                            </div>
                            <div class="col-md-6">
                                <?php echo ReCaptcha::htmlFormSnippet(); ?>

                                <?php $__errorArgs = ['g-recaptcha-response d-block'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/558456.cloudwaysapps.com/vsuwfgzjnz/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>