...
<?php $__env->startSection('page_header'); ?>
    <div class="container-fluid">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add',app($dataType->model_name))): ?>
            <a href="<?php echo e(route('admin_customer_export')); ?>" target="_blank" class="btn btn-success btn-add-new">
                <i class="voyager-file-text"></i> <span>Exportar Registros</span>
            </a>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/558456.cloudwaysapps.com/vsuwfgzjnz/public_html/resources/views/vendor/voyager/customers/browse.blade.php ENDPATH**/ ?>